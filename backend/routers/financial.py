...
from models import FinancialSummaryCreate, FinancialSummaryResponse
...
async def create_financial_summary(summary: FinancialSummaryCreate, current_user: dict = Depends(get_current_user)):
    ...
    amount_to_deposit = summary.total_estimated_receivables * summary.deposit_percentage / 100
    summary_doc = {
